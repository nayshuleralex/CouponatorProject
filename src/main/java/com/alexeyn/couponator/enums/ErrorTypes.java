...
public enum ErrorTypes {
    ...
    NAME_ALREADY_EXIST("The name you chose already exist. Enter another name", false),
    ...
    COUPON_EXPIRED("The coupon is expired", false),
    COUPON_TITLE_EXIST_FOR_COMPANY("The company already have a coupon with the same title",false),
    COUPON_PER_COMPANY_DOES_NOT_EXIST("There is no coupon for such company in DB", false),
    CANNOT_UPDATE_COMPANY_ID("Coupons company ID cannot be changed", false),
    COUPON_TYPE_DOES_NOT_EXIST("Coupon type doesn't exist", false),
    ...
    NULL_DATA("Provided Data is not instantiated", false),
    COUPON_DOES_NOT_EXIST("Coupon doesn't exist", false),
    COUPON_ALREADY_EXIST("Coupon already exist", false),
    ...
    UPDATE_FAILED("Cannot update table", false);
